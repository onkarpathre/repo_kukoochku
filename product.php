...
<div>
We are extremely pleased to present to you our KuKooChKu Poultry Farm Brochure. We are sure you will receive it extremely well. Please 
<a href="KuKooChKupf Brochure.pdf" download="KuKooChKupf Brochure.pdf">download from here</a>
</div>

<!--01-->
<?php
		$sel_product = $obj->select("*","product","visible='yes'");
		
		if($sel_product != "no")
		{
			$count = 0;
			foreach($sel_product as $selproduct=>$product_val)
			{
				$count++;
?>
...
<div class="row">
<div class="col-md-4">
<img src="kukoos2016/uploads/product/<?php echo $product_val[2]; ?>" class="img-responsive" style="margin:5px 0 20px 0;" />
</div>

<div class="col-md-8">
<h3><?php echo $product_val[1]; ?></h3>

<?php echo $product_val[3]; ?>
