...
<div class="col-md-12">
<h3>Services</h3>
<img src="images/services.png" class="milstome_img img-responsive center-block"/>
</div>
</div>

<!--01-->
<?php
		$sel_service = $obj->select("*","service","visible='yes'");
		
		if($sel_service != "no")
		{
			$count = 0;
			foreach($sel_service as $selservice=>$service_val)
			{
				$count++;
?>
...
<div class="row">
<div class="col-md-4">
<img src="kukoos2016/uploads/service/<?php echo $service_val[2]; ?>" class="img-responsive" style="margin:5px 0 20px 0;" />
</div>

<div class="col-md-8">
<h3><?php echo $service_val[1]; ?></h3>

<?php echo $service_val[3]; ?>
