...
{
        $ans = $obj->select("*","meet_the_team","1 order by id desc");
...
<title>Kukoo's Meet The Team</title>
          ...
          <div class="widget">
            <div class="widget-content" style="padding:0px;">
              <div class="widget big-stats-container">
				...
				<div style="float:left; margin-bottom:0px; margin-top:23px; width:auto; height:auto; overflow:hidden;"> <a class="btn btn-small btn-primary my_button3" title="Add New" style="height:29px; font-size:15px; line-height:28px; width:90px; margin-left:15px;">Add Team Member</a> </div>
				...
				?>
					...
					?>
                    <?php include_once("pagination_managemeettheteam.php"); ?>
                    <?php 
						if($count > 0)
						{
...
<div id="element_to_pop_up3" class="popupbox tableout" style="height:auto; width:auto; margin-top:100px; " >
  ...
  <div style="width:auto; height:auto; padding:20px 20px 5px 20px; float:left; border:1px #ccc solid; border-radius:3px; margin:0px 30px 18px;">
    <table class="tableout">
      <tr>
        <td><div id="category">
          <form  method="post"  name ="mainForm" enctype="multipart/form-data" action="meettheteam_action.php" onSubmit="return imagefunction_new(this);" >
            <table class="tablein"  >
			<tr>
			...
			<tr>
                <td valign="top" ><strong style="font-size:16px; color:#000; font-weight:bold;">Designation:</strong><font style="color:#F00; padding-right:10px;">*</font></td>
                <td valign="top"><input type="text" name="name1" id="name1"   style=" margin-top:5px;" /></td>
            </tr>
            <tr>
  ...
  function getid(id)
   {
	...
	$.ajax({
			type:"POST",
			url:"meettheteam_visibility_Ajax.php",
			data:dataString,
