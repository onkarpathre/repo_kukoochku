...
{
$ans = $obj->select("*","clientspeak","flag=0 order by id desc");
}
//print_r($ans);
  		if($ans == 'no')
		{
...
<title>Kukoo's | Manage Client Speak</title>
  ...
  function getid(id)
   {
	...
	$.ajax({
			type:"POST",
			url:"ajax-clientspeak-visibility.php",
			data:dataString,
        ...
        <div class="span12">
          <div class="widget">
            <div class="widget-content" style="padding:0px;">
              <div class="widget big-stats-container">
                <div class="widget-header" style="border-top:0px; border-left:0px; border-right:0px; border-radius:5px 5px 0 0;" > <i class="icon-list-alt"></i>
                  <h3>Manage client Speak</h3>
                </div>
                <div id=""  oncontextmenu="return false;" style="min-height:500px;">
                  <div style="float:left; margin-bottom:0px; margin-top:23px; width:auto; height:auto; overflow:hidden;"> <a  class="btn btn-small btn-primary my_button3" title="Add New Client" style="height:29px; font-size:15px; line-height:28px; width:90px; margin-left:15px;">Add Client Speak</a> </div>
                  <?php
			if($flag)
			{
			?>
			...
			?>
              ...
              ?>
                    <?php include_once("pagination_manageclientspeak.php"); ?>
                    <?php 
if($count > 0)
{
...
<div id="element_to_pop_up3" class="popupbox tableout" style="height:auto; width:auto; margin-top:100px; " >
  ...
  <div style="width:auto; height:auto; padding:20px 20px 5px 20px; float:left; border:1px #ccc solid; border-radius:3px; margin:0px 30px 18px;">
    <table class="tableout">
      <tr>
        <td><div id="category">
          <form  method="post"  name ="mainForm" enctype="multipart/form-data" action="clientspeak_action.php" onSubmit="return imagefunction_new(this);" >
            <table class="tablein"  >
			  ...
			  <tr>
			   ...
			   <tr>
                <td valign="top" ><strong style="font-size:16px; color:#000; font-weight:bold;">Client Name:</strong><font style="color:#F00; padding-right:10px;">*</font></td>
