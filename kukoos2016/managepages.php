...
{
        $ans = $obj->select("*","pages","1 order by id desc");
          ...
          <div class="widget">
            <div class="widget-content" style="padding:0px;">
              <div class="widget big-stats-container">
                <div class="widget-header" style="border-top:0px; border-left:0px; border-right:0px; border-radius:5px 5px 0 0;" > <i class="icon-list-alt fa fa-file-text-o"></i>
                  <h3>Manage Pages</h3>
                </div>
                <div id=""  oncontextmenu="return false;" style="min-height:500px;">
				<!--<div style="float:left; margin-bottom:0px; margin-top:23px; width:auto; height:auto; overflow:hidden;"> <a class="btn btn-small btn-primary my_button3" title="Add New" style="height:29px; font-size:15px; line-height:28px; width:90px; margin-left:15px;">Add CMS</a> </div>-->
                  ...
                  <?php
					...
					{
				?>
                    <div class="pagination" style="width:87%; float:right; text-align:right; margin-top:24px; margin-right:5px;">
					...
					?>
                    <?php include_once("pagination_managepages.php"); ?>
                    <?php 
						if($count > 0)
						{
...
<div id="element_to_pop_up3" class="popupbox tableout" style="height:auto; width:auto; margin-top:100px; " >
  ...
  <div style="width:auto; height:auto; padding:20px 20px 5px 20px; float:left; border:1px #ccc solid; border-radius:3px; margin:0px 30px 18px;">
    <table class="tableout">
      <tr>
        <td><div id="category">
          <form  method="post"  name ="mainForm" enctype="multipart/form-data" action="pages_action.php" onSubmit="return imagefunction_new(this);" >
            <table class="tablein"  >
			<tr>
                <td valign="top" ><strong style="font-size:16px; color:#000; font-weight:bold;">Page Name:</strong><font style="color:#F00; padding-right:10px;">*</font></td>
                <td valign="top"><input type="text" name="name" id="name"   style=" margin-top:5px;" /></td>
            </tr>
            <tr>
			  ...
			  <tr>
                ...
                <td valign="top"><textarea class="ckeditor" cols="20"  rows="5" name="content" id="content"   style=" margin-top:5px;" /></textarea></td>
              </tr>
              <tr>
  ...
  function getid(id)
   {
	...
	$.ajax({
			type:"POST",
			url:"banner_visibility_Ajax.php",
			data:dataString,
...
$(document).ready(function() {
 ...
 function getValueUsingClass(){
	...
	if(selected.length != ''){
		 var c = confirm("Are you sure want to delete these Comments from Banner ?");
        if(c == true)
        {
