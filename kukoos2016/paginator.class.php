...
class Paginator{
	...
	function paginate()
	{
		...
		if($this->num_pages > 10)
		{
			...
			$this->return .= ($_GET['page'] == 'All') ? "<a class=\"current\" style=\"margin-left:10px\" href=\"#\" style='width:40px;'>All</a> \n":"<a class=\"paginate\" style=\"margin-left:10px\" href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\" style='width:40px;' >All</a> \n";
		}
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
			...
			$this->return .= "<a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\" style='width:40px;'>All</a> \n";
		}
