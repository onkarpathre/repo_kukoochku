(function ($) {
    ...
    'namespace sumo';
    $.fn.sumoselect1 = function (options) {
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    var O = this;
                    O.E.wrap('<div class="sumoselect1" tabindex="0">');
                    O.select = O.E.parent();
                    O.caption = $('<span></span>');
                    O.CaptionCont = $('<p class="CaptionCont"><label><i></i></label></p>').addClass('SlectBoxa').attr('style', O.E.attr('style')).prepend(O.caption);
...
//                                O.hideOpts();
                ...
                */
                reload:function(){
                    var elm = this.unload();
                    return $(elm).sumoselect1(settings);
                },
