...
{
$ans = $obj->select("*","banner","flag=0 order by id desc");
}
//print_r($ans);
  		if($ans == 'no')
		{
...
<title>Kukooo's | Manage Banner</title>
...
$(document).ready(function() {
 ...
 function getValueUsingClass(){
	...
	if(selected.length != ''){
		 var c = confirm("Are you sure want to delete Banner ?");
        if(c == true)
        {
            ...
            <div class="widget-content" style="padding:0px;">
              <div class="widget big-stats-container">
                ...
                <div id=""  oncontextmenu="return false;" style="min-height:500px;">
                  <div style="float:left; margin-bottom:0px; margin-top:23px; width:auto; height:auto; overflow:hidden;"> <a class="btn btn-small btn-primary my_button3" title="Add New User" style="height:29px; font-size:15px; line-height:28px; width:90px; margin-left:15px;">Add Banner</a> </div>
                  <?php
					if($flag)
					{
					?>
              ...
              ?>
                    <?php include_once("pagination_managebanner.php"); ?>
                    <?php 
						if($count > 0)
						{
...
<div id="element_to_pop_up3" class="popupbox tableout" style="height:auto; width:auto; margin-top:100px; " >
  ...
  <div style="width:auto; height:auto; padding:20px 20px 5px 20px; float:left; border:1px #ccc solid; border-radius:3px; margin:0px 30px 18px;">
    <table class="tableout">
      <tr>
        <td><div id="category">
          <form  method="post"  name ="mainForm" enctype="multipart/form-data" action="banner_action.php" onSubmit="return imagefunction_new(this);" >
            <table class="tablein"  >
              <tr>
                <td valign="top" ><strong style="font-size:16px; color:#000; font-weight:bold;">Select Banner:</strong><font style="color:#F00; padding-right:10px;">*</font></td>
                <td valign="top"><input type="file" name="files[]" id="files" multiple="multiple"  accept="image/*"  style=" margin-top:5px;" />
                  <br/>
                  <font color="#FF0000" style="font-size:12px; line-height:16px;">Please select jpeg,png,gif image only<br/>
                  Size:1400px*450px</font> </td>
              </tr>
			  <tr>
                <td valign="top" ><strong style="font-size:16px; color:#000; font-weight:bold;">Content:</strong><font style="color:#F00; padding-right:10px;">*</font></td>
                <td valign="top"><textarea rows="5" cols="20" name="content" id="content"   style=" margin-top:5px;"></textarea>
               </td>
              </tr>
              <tr>
