...
$page_id='8';
	...
	{
		header("location:manage_product.php?page=1&ipp=20");
	}
	else
	{
		$id = $_REQUEST["sd"];
		$res=$obj->select("*","product","id=$id");
		 ...
		 $description = addslashes($_REQUEST["description"]);
		   ...
		   if(!(empty($_FILES['file']['name'])))
			...
			$image = $_REQUEST['files1exist'];
		       ...
		       $update_product=$obj->update("product","name='$product_name',image ='$image',description='$description'","id=$id");
...
<title>Kukoo's | Edit Product.&#8230;</title>
...
<script>
	...
	function formvalidate(oForm)
	{
		...
		var pre_gal = $("#pre_gal").val();
		var gimage = $("#files").val();
		if(cate_name == "")
		{
		...
		if(gimage == "" && pre_gal==0)
		{
			alert("There must be atleast one Image in product");
			return false;
		}
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="widget big-stats-container">
                <div class="widget-content">
                  <form  id="mainForm"  name="mainForm" method="post"  enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF']; ?>"  onSubmit="return formvalidate(this);" >
                    <table align="center" border="0" width="80%" cellpadding="0" cellspacing="0" id="id-form" style="border:1px #efefef solid;padding:30px 0px 25px 25px; border-collapse: separate;">
                      <tbody>
                        <tr>
                          ...
                          <td width="65%" align="left"><input type="text" placeholder="Enter Name" name="productname" value="<?php echo  $name ;?>"  id="productname" class="inp"/>
                          </td>
                        </tr>
                        <tr>
						...
						<tr>
                          <td width="20%" align="left" valign="top"><strong>Product Description</strong><font style="color:#F00; padding-right:10px;">*</font></td>
                          <td width="5%" align="center" valign="top"><strong>:</strong></td>
                          <td width="75%" align="left"><textarea class="ckeditor" cols="50"  rows="10" value="" placeholder="Enter Description" class="inp" name="description" id="description" style="margin-left:0px;"><?php echo  $description ;?></textarea>
                        ...
                        <tr>
                          <td width="20%" align="left" valign="top"><strong>Product Image</strong></td>
                          <td width="5%" align="center" valign="top"><strong>:</strong></td>
                          <td width="75%" align="left"><div class="inp-file">
						    <img src="uploads/product/<?php echo $image;?>" alt="" border="0" width="100" height="100" class="thumbnail"  /><br />
                        ...
                        <tr>
                          <td width="20%" align="left" valign="top"><strong>Active Status</strong><font style="color:#F00; padding-right:10px;">*</font></td>
                          <td width="5%" align="center" valign="top"><strong>:</strong></td>
                          <td width="75%" align="left"><input id="element_5" name="visible"  type="radio" value="yes" style=" margin-top:5px; float:left;" checked="checked" />
                        ...
                        <tr>
                          <td colspan="3" align="center"><input type="submit" name="submit" id="submit" value="Update" class="btn btn-primary" style="border-radius:2px;" />
                            &nbsp;&nbsp;&nbsp;&nbsp;
