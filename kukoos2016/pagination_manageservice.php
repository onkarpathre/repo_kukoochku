...
if(isset($_REQUEST['page']) && isset($_REQUEST['ipp']))
{
	$i=1;
		...
		$max_results = $_REQUEST['ipp'];//20;
			...
			if($max_results != 'All')
			{
				...
				$pagesdata = $obj->select("*","service","flag=0 order by id ASC LIMIT $from, $max_results  ");
			...
			{
				$pagesdata =  $obj->select("*","service","flag=0 order by id ASC");
		...
		?>
                                ...
                                <div class="widget-content">
                                    ...
                                    <tr class="gridViewHeader" bgcolor="#f9f9f9">
									  ...
									  <td align="center" class="sec" style="background:#e6e4e4; padding:0px;">Image</td>
	...
	<?php 
				...
				{
			?>
     <td>&nbsp;<img src="uploads/service/<?php echo $val[2];?>" width="150px" height="150px" /> </td>
	 <?php
				}
				else
				{
   ...
   <td align="center" style="text-align:center; padding:4px;">
	  <input class="checkbox1" type="checkbox" name="check[]" id="<?php echo $id ?>" value="<?php echo $id ?>"  />
		&nbsp;&nbsp;
		<a href="edit_service.php?sd=<?php echo $val[0];?>" class="btn btn-small btn-success" title="Edit"  style="width:28px; height:23px; line-height:14px;"><i class="btn-icon-only icon-pencil" style="padding-top:2px; float:left; font-size:15px; padding-left:9px;"> </i></a>&nbsp;
      </td>
    </tr>
	<?php
