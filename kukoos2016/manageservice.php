...
{
$ans = $obj->select("*","service","flag=0 order by id desc");
}
//print_r($ans);
  		if($ans == 'no')
		{
...
<title>Kukoo's | Manage Services</title>
  ...
  function getid(id)
   {
	...
	$.ajax({
			type:"POST",
			url:"ajax-services-visibility.php",
			data:dataString,
        ...
        <div class="span12">
          <div class="widget">
            <div class="widget-content" style="padding:0px;">
              <div class="widget big-stats-container">
                ...
                <div id=""  oncontextmenu="return false;" style="min-height:500px;">
                  <div style="float:left; margin-bottom:0px; margin-top:23px; width:auto; height:auto; overflow:hidden;"> <a  class="btn btn-small btn-primary my_button3" title="Add New Service" style="height:29px; font-size:15px; line-height:28px; width:90px; margin-left:15px;">Add Service</a> </div>
                  <?php
			if($flag)
			{
			?>
			...
			?>
              ...
              ?>
                    <?php include_once("pagination_manageservice.php"); ?>
                    <?php 
if($count > 0)
{
...
<div id="element_to_pop_up3" class="popupbox tableout" style="height:auto; width:auto; margin-top:100px; " >
  ...
  <div style="width:auto; height:auto; padding:20px 20px 5px 20px; float:left; border:1px #ccc solid; border-radius:3px; margin:0px 30px 18px;">
    <table class="tableout">
      <tr>
        <td><div id="category">
          <form  method="post"  name ="mainForm" enctype="multipart/form-data" action="service_action.php" onSubmit="return imagefunction_new(this);" >
            <table class="tablein"  >
             <tr>
